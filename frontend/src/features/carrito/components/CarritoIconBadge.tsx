...
/**
 * Cart icon with animated badge for the header.
 * Replaces the one in shared/components/layout/CartIconButton.tsx
 * with enhanced pulse animation on item count change.
 */
export function CarritoIconBadge() {
